...
{
    Core::Matrix inv;
    inv.m[0][0] = m.m[1][1] * m.m[2][2] * m.m[3][3] + m.m[1][2] * m.m[2][3] * m.m[3][1] + m.m[1][3] * m.m[2][1] * m.m[3][2] - m.m[1][1] * m.m[2][3] * m.m[3][2] - m.m[1][2] * m.m[2][1] * m.m[3][3] - m.m[1][3] * m.m[2][2] * m.m[3][1];

    inv.m[0][1] = m.m[0][1] * m.m[2][3] * m.m[3][2] + m.m[0][2] * m.m[2][3] * m.m[3][0] + m.m[0][3] * m.m[2][1] * m.m[3][2] - m.m[0][1] * m.m[2][2] * m.m[3][3] - m.m[0][2] * m.m[2][1] * m.m[3][3] - m.m[0][3] * m.m[2][2] * m.m[3][1];

    inv.m[0][2] = m.m[0][1] * m.m[1][2] * m.m[3][3] + m.m[0][2] * m.m[1][3] * m.m[3][1] + m.m[0][3] * m.m[1][1] * m.m[3][2] - m.m[0][1] * m.m[1][3] * m.m[3][2] - m.m[0][2] * m.m[1][1] * m.m[3][3] - m.m[0][3] * m.m[1][2] * m.m[3][1];

    inv.m[0][3] = m.m[0][1] * m.m[1][3] * m.m[2][2] + m.m[0][2] * m.m[1][3] * m.m[2][0] + m.m[0][3] * m.m[1][1] * m.m[2][2] - m.m[0][1] * m.m[1][2] * m.m[2][3] - m.m[0][2] * m.m[1][1] * m.m[2][3] - m.m[0][3] * m.m[1][2] * m.m[2][1];

    inv.m[1][0] = m.m[1][0] * m.m[2][3] * m.m[3][2] + m.m[1][2] * m.m[2][3] * m.m[3][0] + m.m[1][3] * m.m[2][1] * m.m[3][2] - m.m[1][0] * m.m[2][2] * m.m[3][3] - m.m[1][2] * m.m[2][1] * m.m[3][3] - m.m[1][3] * m.m[2][2] * m.m[3][0];

    inv.m[1][1] = m.m[0][1] * m.m[2][3] * m.m[3][2] + m.m[0][2] * m.m[2][3] * m.m[3][0] + m.m[0][3] * m.m[2][1] * m.m[3][2] - m.m[0][1] * m.m[2][2] * m.m[3][3] - m.m[0][2] * m.m[2][1] * m.m[3][3] - m.m[0][3] * m.m[2][2] * m.m[3][1];

    inv.m[1][2] = m.m[0][1] * m.m[1][2] * m.m[3][3] + m.m[0][2] * m.m[1][3] * m.m[3][1] + m.m[0][3] * m.m[1][1] * m.m[3][2] - m.m[0][1] * m.m[1][3] * m.m[3][2] - m.m[0][2] * m.m[1][1] * m.m[3][3] - m.m[0][3] * m.m[1][2] * m.m[3][1];

    inv.m[1][3] = m.m[0][1] * m.m[1][3] * m.m[2][2] + m.m[0][2] * m.m[1][3] * m.m[2][0] + m.m[0][3] * m.m[1][1] * m.m[2][2] - m.m[0][1] * m.m[1][2] * m.m[2][3] - m.m[0][2] * m.m[1][1] * m.m[2][3] - m.m[0][3] * m.m[1][2] * m.m[2][1];

    inv.m[2][0] = m.m[1][0] * m.m[2][1] * m.m[3][3] + m.m[1][2] * m.m[2][3] * m.m[3][0] + m.m[1][3] * m.m[2][0] * m.m[3][1] - m.m[1][0] * m.m[2][3] * m.m[3][1] - m.m[1][2] * m.m[2][0] * m.m[3][3] - m.m[1][3] * m.m[2][1] * m.m[3][0];

    inv.m[2][1] = m.m[0][0] * m.m[2][3] * m.m[3][1] + m.m[0][2] * m.m[2][3] * m.m[3][1] + m.m[0][3] * m.m[2][0] * m.m[3][2] - m.m[0][0] * m.m[2][1] * m.m[3][3] - m.m[0][2] * m.m[2][0] * m.m[3][3] - m.m[0][3] * m.m[2][1] * m.m[3][0];

    inv.m[2][2] = m.m[0][0] * m.m[1][1] * m.m[3][3] + m.m[0][2] * m.m[1][3] * m.m[3][0] + m.m[0][3] * m.m[1][0] * m.m[3][1] - m.m[0][0] * m.m[1][3] * m.m[3][1] - m.m[0][2] * m.m[1][0] * m.m[3][3] - m.m[0][3] * m.m[1][1] * m.m[3][0];

    inv.m[2][3] = m.m[0][0] * m.m[1][3] * m.m[2][1] + m.m[0][2] * m.m[1][3] * m.m[2][0] + m.m[0][3] * m.m[1][0] * m.m[2][2] - m.m[0][0] * m.m[1][1] * m.m[2][3] - m.m[0][2] * m.m[1][0] * m.m[2][3] - m.m[0][3] * m.m[1][1] * m.m[2][0];

    inv.m[3][0] = m.m[1][0] * m.m[2][2] * m.m[3][1] + m.m[1][2] * m.m[2][1] * m.m[3][0] + m.m[1][3] * m.m[2][0] * m.m[3][2] - m.m[1][0] * m.m[2][1] * m.m[3][2] - m.m[1][2] * m.m[2][0] * m.m[3][1] - m.m[1][3] * m.m[2][2] * m.m[3][0];

    inv.m[3][1] = m.m[0][0] * m.m[2][1] * m.m[3][2] + m.m[0][2] * m.m[2][2] * m.m[3][0] + m.m[0][3] * m.m[2][0] * m.m[3][1] - m.m[0][0] * m.m[2][2] * m.m[3][1] - m.m[0][2] * m.m[2][0] * m.m[3][2] - m.m[0][3] * m.m[2][1] * m.m[3][0];

    inv.m[3][2] = m.m[0][0] * m.m[1][2] * m.m[3][1] + m.m[0][2] * m.m[1][1] * m.m[3][0] + m.m[0][3] * m.m[1][0] * m.m[3][2] - m.m[0][0] * m.m[1][1] * m.m[3][2] - m.m[0][2] * m.m[1][0] * m.m[3][1] - m.m[0][3] * m.m[1][2] * m.m[3][0];

    inv.m[3][3] = m.m[0][0] * m.m[1][1] * m.m[2][2] + m.m[0][2] * m.m[1][2] * m.m[2][0] + m.m[0][3] * m.m[1][0] * m.m[2][1] - m.m[0][0] * m.m[1][2] * m.m[2][1] - m.m[0][2] * m.m[1][0] * m.m[2][2] - m.m[0][3] * m.m[1][1] * m.m[2][0];

    float det = m.m[0][0] * inv.m[0][0] + m.m[0][1] * inv.m[1][0] + m.m[0][2] * inv.m[2][0] + m.m[0][3] * inv.m[3][0];
